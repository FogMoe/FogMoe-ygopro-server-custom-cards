--Hollow Knight-格林剧团
function c112035.initial_effect(c)
	--link summon
	...
	e1:SetCondition(c112035.indcon)
	e1:SetValue(1)
	c:RegisterEffect(e1)  
	--atk 1000
	local e1=Effect.CreateEffect(c)
	...
	e2:SetCountLimit(1,112035)
	e2:SetTarget(c112035.bctg)
	e2:SetOperation(c112035.bcop)
	c:RegisterEffect(e2)
	--SpecialSummon
	...
	e3:SetTarget(c112035.sptg)
	e3:SetOperation(c112035.spop)
	c:RegisterEffect(e3)
end
function c112035.indcon(e)
	return e:GetHandler():IsLinkState()
end
function c112035.bctg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c112035.bcop(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c112035.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c112035.spop(e,tp,eg,ep,ev,re,r,rp,chk)
