...
function c94000.initial_effect(c)
	...
	c:RegisterEffect(e3)
	Duel.AddCustomActivityCounter(94000,ACTIVITY_SPSUMMON,c94000.counterfilter)
	---atkdown
...
function c94000.counterfilter(c)
	return c:IsSetCard(0x9400)
end
function c94000.allcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetCustomActivityCount(94000,tp,ACTIVITY_SPSUMMON)==0 end
	...
	e1:SetTarget(c94000.alllimit)
	Duel.RegisterEffect(e1,tp)
end
function c94000.alllimit(e,c,sump,sumtype,sumpos,targetp,se)
