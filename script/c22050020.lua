...
function c22050020.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if g:GetCount()>0 then
		...
		if Duel.GetMatchingGroupCount(c22050020.filter0,tp,LOCATION_MZONE,0,1,nil)>=0 and Duel.IsExistingMatchingCard(c22050020.tgfilter,tp,LOCATION_DECK,0,1,nil)
